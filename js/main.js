...
function SaveTask(){
    ...
    SetElementText('inputTextArea',eids.uid);
    SetElementText('inputDate',eids.lid);
    AddToTasks(eids);
...
function IsUserWroteDescription(){
    var input_textarea = document.getElementById('inputTextArea').value;
    return (!input_textarea == undefined || !input_textarea == "" || !input_textarea.length==0);
    
}

function IsUserWroteDate(){
    var input_date = document.getElementById('inputDate').value;
    return (!input_date == undefined || !input_date == "" || !input_date.length==0);
    
}

function IsValidDate(){
    var input_date_string = document.getElementById('inputDate').value;
